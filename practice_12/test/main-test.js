...
describe('oo', () => {
    ...
    it('practice_12_Student_inherited Person_Tom is leader', () => {
    ...
    it('practice_12_Student_inherited Person_there is no leader', () => {
    ...
    it('practice_12_Student_inherited Person_other is leader', () => {
    ...
    it('practice_12_Student_inherited Person_Tom is not appended', () => {
        let class2=new Class(2);
        let klass=new Class(2);
        let Tom = new Student('id', "Tom", 21, klass);
    ...
    it('practice_12_Student_inherited Person_Tom is not appended and introduce', () => {
        let class2=new Class(2);
        let klass=new Class(2);
        let Tom = new Student('id', "Tom", 21, klass);
        class2.appendMember();
    ...
    it('practice_12_Teacher_inherited Person_introduce', () => {
        let class2=new Class(2);
    ...
    it('practice_12_Teacher_inherited Person_isTeachingT', () => {
        let class2=new Class(2);
        let class3=new Class(3);
        let klass=new Class(2);
    ...
    it('practice_12_Teacher_inherited Person_isTeachingF', () => {
        let class2=new Class(2);
        let class3=new Class(3);
        let klass=new Class(2);
        let Jack=new Student('id',"Jack",12,klass);
    ...
    it('practice_12_Teacher_inherited Person_isTeachingF_student join', () => {
        let class2=new Class(2);
        let class3=new Class(3);
        let klass=new Class(2);
        let Jerry=new Student('id',"Jerry",12,klass);
        let result=new Teacher('id', "Tom", 21,[class2,class3]).print(Jerry,'join');
        expect(result).toEqual('I am Tom. I know Jerry has joined Class 2.');
    });
    it('practice_12_Teacher_inherited Person_isTeachingF_student join and lead', () => {
        let class2=new Class(2);
        let class3=new Class(3);
        let klass=new Class(2);
        let Jerry=new Student('id',"Jerry",12,klass);
        let result=new Teacher('id', "Tom", 21,[class2,class3]).print(Jerry,'join and lead');
        expect(result).toEqual('I am Tom. I know Jerry become Leader of Class 2.');
    });
});